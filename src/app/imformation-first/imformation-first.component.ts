...
@Component({
  selector: 'app-imformation-first',
  templateUrl: './imformation-first.component.html',
  styleUrls: ['./imformation-first.component.css'],
})
export class ImformationFirstComponent {
  // Real date logic
